...
public class CaptureAndRecognizeActivity extends ActionBarActivity {

	private static final String TAG = "CaptureAndRecognizeActivity";
	private static final int CAPTURE_PICTURE_ACTIVITY_REQUEST_CODE = 0;
	...
	private static final String MyPREF = "adsPref";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String fileName = "Image F.E.R. - "+tsLong;  
		...
		startActivityForResult(intent, CAPTURE_PICTURE_ACTIVITY_REQUEST_CODE);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent imageReturnedIntent) {
	    ...
	    switch (requestCode) {
	        case CAPTURE_PICTURE_ACTIVITY_REQUEST_CODE:
	            ...
	            if (resultCode == RESULT_OK) {
	                ...
	                if (cursor.moveToFirst()) {
	                    ...
	                    title = "Image F.E.R.";	//mCapturedImageURI.getLastPathSegment();
	                    ...
	                    recognizer = new Recognizer(this, imgAdapt, faceGallery, 
                 			   faceView, filePath, progStr, mCapturedImageURI);
	                    recognizer.execute();
	            	...
	            	if(mCapturedImageURI != null)
						getApplicationContext().getContentResolver().delete(mCapturedImageURI, null, null);
